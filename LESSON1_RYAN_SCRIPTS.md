...
### SEGMENT 1 — LESSON INTRO
*(Ryan orb active, Sofia idle on beach in background)*

"What you are about to see is something most men spend their entire lives never figuring out.
...
### SEGMENT 2 — BEFORE THE APPROACH
*(Ryan orb active, Sofia idle, not yet aware)*

"Before I take a single step toward her, I want you to notice what I am not doing.
...
### SEGMENT 3 — THE APPROACH (scripted live exchange)
*(Ryan approaches Sofia)*

Ryan: "Hey — sorry to interrupt. Can I tell you something for just a second?"

Sofia: [speaking] "...sure." [idle]

Ryan: "I was walking past and I had to stop. You have this energy — like you belong somewhere else entirely. Not here. Somewhere quieter. More interesting. I don't know why but that caught my attention."

Sofia: [speaking] "...that's a strange thing to notice." [idle]

Ryan: "Strange things are usually the most true."

Sofia: [speaking — small pause] "...okay." [idle — slight smile]

---

### SEGMENT 4 — EXPLAINING THE OPENER (Step 1)
*(Ryan orb, Sofia idle)*
...
### SEGMENT 5 — THE TEASE (scripted live exchange)
*(Ryan and Sofia continuing)*

Ryan: "You've been sitting here a while. Writing something?"

Sofia: [speaking] "Just thinking." [idle]

Ryan: "People who say they're just thinking are always thinking about something very specific."

Sofia: [speaking] "...maybe." [idle]

Ryan: "You don't give much away do you."

Sofia: [speaking] "Should I?" [idle]

Ryan: "No. Actually — that's interesting. Most people give everything away in the first thirty seconds. You didn't."

Sofia: [speaking — slight pause] "...you're very observant." [idle]

Ryan: "It's a problem sometimes."

---

### SEGMENT 6 — EXPLAINING THE TEASE (Step 2)
*(Ryan orb, Sofia idle)*

"Did you feel the shift in that exchange?
...
When I said 'people who say they're just thinking are always thinking about something very specific' — I was not insulting her. I was paying attention. I was curious. And I was showing it in a way that created a small, pleasant friction.
...
### SEGMENT 7 — THE SENSITIVE TOPIC (scripted live exchange)
*(Ryan and Sofia continuing)*

Sofia: [speaking] "So what do you do — are you here on holiday or..." [idle]

Ryan: "Why — are you trying to figure out if I'm worth talking to?"

Sofia: [speaking] "...I'm just making conversation." [idle]

Ryan: "Fair enough. I work in something I'm not going to explain at a party because it kills the mood immediately. What I will tell you is that I chose it because it lets me be here on a Tuesday afternoon. That tells you more than the job title would."

Sofia: [speaking — small laugh] "...that's a very careful answer." [idle]

Ryan: "I'm a careful person. When it matters."

---

### SEGMENT 8 — EXPLAINING THE SENSITIVE TOPIC (Step 3)
*(Ryan orb, Sofia idle)*

"She asked about my work. A simple question. One that most men answer immediately and completely — name of the company, job title, salary range implied, full resume delivered in ninety seconds.
...
### SEGMENT 9 — THE VERBAL SPIKE (scripted live exchange)
*(Ryan and Sofia continuing)*

Ryan: "You know what I noticed about you from over there? Before I came over."

Sofia: [speaking] "What?" [idle]

Ryan: "You looked like someone who was completely fine being alone. Not lonely. Not waiting for something. Just — present. You don't see that very often."

Sofia: [speaking — pause] "...most people find that strange." [idle]

Ryan: "I find it rare. There's a difference. Rare things are worth paying attention to. That's why I'm here."

Sofia: [speaking — quiet] "...that's actually a nice thing to say." [idle]

---

### SEGMENT 10 — EXPLAINING THE VERBAL SPIKE (Step 4)
*(Ryan orb, Sofia idle)*

"I want you to go back and listen to what I just said to her.
...
A verbal spike is not flirting in the obvious sense. It is not 'you're beautiful' or 'I think you're amazing.' Those things land flat because they are about her appearance. They tell her nothing about you.
...
### SEGMENT 11 — THE CLOSE (scripted live exchange)
*(Ryan and Sofia, natural end of conversation)*

Ryan: "I have to be honest with you — I didn't plan to spend twenty minutes talking to a stranger on a beach today."

Sofia: [speaking] "...is that a complaint?" [idle]

Ryan: "No. It's the opposite actually. Look — I'm going to be direct because I think you appreciate that more than most people. I'd like to continue this conversation somewhere that isn't a beach with sand in my shoes. Coffee. A drink. Whenever works for you. No pressure."

Sofia: [speaking — pause] "...yeah. I'd like that." [idle]

Ryan: "Good. Give me your number and I'll make it worth your while."

Sofia: [speaking — small laugh] "...confident." [idle]

Ryan: "Comfortable. There's a difference."

---

### SEGMENT 12 — EXPLAINING THE CLOSE (Step 5)
*(Ryan orb, Sofia idle)*

"You think the close is the hardest part. It is not.
...
### SEGMENT 13 — THE SUMMARY AND SEND-OFF
*(Ryan orb only, no Sofia)*

"Here is what just happened. And here is what I need you to remember.
...
## RECORDING NOTES FOR FISH AUDIO

- Tone: Calm, authoritative, slightly intense. Never rushed.
- Pace: Slower than natural speech. Let the pauses land.
- Key moments to slow down even further:
  - Any time a step number is stated ("Step 1", "Step 2" etc.)
  - The final line of each segment
  - Any single-sentence paragraph — these are designed as impact moments
- Total estimated runtime: 9-12 minutes
- Record each segment as a separate MP3 file
- File naming: lesson1_seg01.mp3, lesson1_seg02.mp3 etc.
- Store all files in Cloudflare R2 under: /lessons/lesson1/audio/
